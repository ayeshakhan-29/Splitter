  ...
  const calculateTipPerPerson = () => {
    ...
    const tipPerPerson =
      numberOfPeople === "" || numberOfPeople === "0"
        ? 0
        : tip / parseFloat(numberOfPeople);
    const totalBillWithTip = bill + tip;
    const billPerPerson =
      numberOfPeople === "" || numberOfPeople === "0"
        ? 0
        : totalBillWithTip / parseFloat(numberOfPeople);
  ...
  return (
    <div className=" md:h-screen h-screen w-screen md:w-screen md:flex md:flex-col md:items-center md:justify-center bg-[#c5e4e7]">
      <div className="text-center md:py-0 py-6">
        ...
        <br />
        <span className="uppercase font-mono text-3xl mt-2 text-[#114A4E] tracking-widest">
          tter
        </span>
      </div>
        ...
        <div className="h-full w-full justify-center md:max-w-sm p-4 md:h-full">
          ...
          <div className="relative mt-1 rounded-md shadow-sm">
            <div className="absolute inset-y-0 left-0 pl-3 flex pointer-events-none">
              <span className="text-gray-400 mt-3 md:mt-4 text-lg md:text-lg">
                $
              </span>
            </div>
            <input
          ...
          <label
            htmlFor="selectTip"
            className="block text-sm font-medium text-gray-500 py-4 md:py-4"
          >
            Select Tip %
          </label>
          ...
          <div className="flex mb-4"> */}
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (
                  value === "" ||
                  (/^\d+$/.test(value) && value >= 1 && value <= 100)
                ) {
            ...
            />
            {customTipPercentage &&
              (parseInt(customTipPercentage) === 0 ||
                parseInt(customTipPercentage) > 100) && (
          ...
          <div className="relative mt-1 rounded-md shadow-sm">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <img
                src={user}
                className="md:h-[1.5rem] h-[1.2rem] mt-12 md:mt-10"
                alt="user"
              />
            </div>
            <div className="flex">
              <label
                ...
                className="block text-sm font-medium text-gray-500 md:py-3 py-3"
              >
                Number of People
              </label>
        ...
        <div className="h-full w-full justify-center md:max-w-sm p-4 md:flex ">
          ...
          <div className=" bg-[#114A4E] rounded-lg md:w-full">
            <div className="p-8 flex justify-between gap-4 items-center  ">
              ...
              <p className="text-4xl font-semibold text-[#26C2AD]">
                ${calculateTipPerPerson().tipPerPerson}
              </p>
            </div>
            ...
            <div className="px-8 flex justify-between gap-3 md:flex md:gap-2 items-center">
              ...
              <p className="text-4xl font-semibold text-[#26C2AD]">
                ${calculateTipPerPerson().billPerPerson}
              </p>
            </div>
            {/* Reset Button */}
