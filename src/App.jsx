      ...
      <div className="h-[42rem] md:h-full grid md:grid-cols-2 bg-white rounded-[1.5rem] m-3 p-2 ">
        <div className="h-full w-full justify-center md:max-w-sm p-4">
          ...
          <div className="flex mb-4">
            ...
            />
            {customTipPercentage && parseInt(customTipPercentage) === 0 && (
              <span className="text-red-500 text-sm font-medium ml-2">can't be zero</span>
            )}
          </div>
          ...
          <div className="relative mt-1 rounded-md shadow-sm">
            ...
            <div className="flex">
              ...
              {numberOfPeople && parseInt(numberOfPeople) === 0 && (
                <span className="text-red-500 text-sm font-medium ml-20 md:ml-32">can't be zero</span>
              )}
            </div>
            <input
              type="number"
